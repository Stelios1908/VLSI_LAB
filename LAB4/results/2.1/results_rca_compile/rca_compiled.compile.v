...
module fulladder_0 ( a, b, cin, s, cout );
  ...
  OAI21x1_ASAP7_75t_R U1 ( .A1(n5), .A2(n4), .B(n3), .Y(cout) );
  XNOR2xp5_ASAP7_75t_R U2 ( .A(n2), .B(n1), .Y(n5) );
  HB1xp67_ASAP7_75t_R U3 ( .A(a), .Y(n1) );
  HB1xp67_ASAP7_75t_R U4 ( .A(b), .Y(n2) );
  INVx1_ASAP7_75t_R U5 ( .A(cin), .Y(n4) );
  XNOR2xp5_ASAP7_75t_R U6 ( .A(cin), .B(n5), .Y(s) );
  NAND2xp5_ASAP7_75t_R U7 ( .A(b), .B(a), .Y(n3) );
endmodule
...
module myreg_2 ( rst, clk, D, Q );
  ...
  ASYNC_DFFHx1_ASAP7_75t_R Q_reg ( .D(n3), .CLK(clk), .RESET(rst), .SET(n2), 
        .QN(Q) );
  TIELOx1_ASAP7_75t_R U3 ( .L(n2) );
  INVxp67_ASAP7_75t_R U4 ( .A(D), .Y(n3) );
endmodule
...
module fulladder_1 ( a, b, cin, s, cout );
  ...
  XOR2xp5_ASAP7_75t_R U1 ( .A(b), .B(a), .Y(n2) );
  INVx1_ASAP7_75t_R U2 ( .A(n2), .Y(n3) );
  AND2x2_ASAP7_75t_R U3 ( .A(b), .B(a), .Y(n1) );
  XNOR2xp5_ASAP7_75t_R U4 ( .A(n3), .B(cin), .Y(s) );
  OA22x2_ASAP7_75t_R U5 ( .A1(n1), .A2(cin), .B1(n2), .B2(n1), .Y(cout) );
endmodule
...
module fulladder_2 ( a, b, cin, s, cout );
  ...
  INVxp33_ASAP7_75t_R U1 ( .A(n3), .Y(n1) );
  XNOR2xp5_ASAP7_75t_R U2 ( .A(n2), .B(n1), .Y(s) );
  NAND2xp5_ASAP7_75t_R U3 ( .A(b), .B(a), .Y(n4) );
  XNOR2xp5_ASAP7_75t_R U4 ( .A(b), .B(a), .Y(n2) );
  INVx2_ASAP7_75t_R U5 ( .A(cin), .Y(n3) );
  AOI22x1_ASAP7_75t_R U6 ( .A1(n4), .A2(n3), .B1(n2), .B2(n4), .Y(cout) );
endmodule
...
module fulladder_3 ( a, b, cin, s, cout );
  ...
  BUFx3_ASAP7_75t_R U1 ( .A(n3), .Y(n1) );
  XNOR2xp5_ASAP7_75t_R U2 ( .A(cin), .B(n4), .Y(s) );
  NAND2xp5_ASAP7_75t_R U3 ( .A(b), .B(a), .Y(n3) );
  INVx2_ASAP7_75t_R U4 ( .A(cin), .Y(n2) );
  XNOR2xp5_ASAP7_75t_R U5 ( .A(b), .B(a), .Y(n4) );
  AOI22x1_ASAP7_75t_R U6 ( .A1(n2), .A2(n1), .B1(n4), .B2(n1), .Y(cout) );
endmodule
